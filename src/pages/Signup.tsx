    ...
    <div className="min-h-screen bg-[#0f0600] flex items-center justify-center px-4">
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black text-amber-100">Create Account</h1>
          <p className="text-amber-400/60 mt-1">Join the CafeHub family</p>
        </div>

        <div className="bg-[#2a1500] border border-amber-900/30 rounded-3xl p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-sm text-amber-400 mb-1.5 block">Full Name</label>
          ...
          <div className="mt-4 p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl text-center">
            <p className="text-xs text-amber-400">🌟 Earn 5 loyalty points for every ₹100 you spend!</p>
          </div>
